...
import com.sudo.portfolio.util.ApplicationContextManager;
...
public class RedisCache implements Cache {
    ...
    private RedisTemplate<Object, Object> getRedisTemplate(){
        return ApplicationContextManager.getApplicationContext().getBean("redisTemplate", RedisTemplate.class);
    }
